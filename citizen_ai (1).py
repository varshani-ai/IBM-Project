...
with gr.Blocks() as app:
    ...
    main_app_section = gr.Column(visible=False)

    with login_section:
        gr.Markdown("## 🔐 Login to Access the App")
        username = gr.Textbox(label="Username")
        password = gr.Textbox(label="Password", type="password")
        login_btn = gr.Button("Login")
        login_status = gr.Markdown("")

    with main_app_section:
    ...
    login_btn.click(fn=check_login, inputs=[username, password], outputs=[login_section, main_app_section, login_status])
